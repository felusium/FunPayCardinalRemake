...
❌ <i>FunPayCardinalRemake</i> еще <b><u>не инициализирован</u></b> и <b><u>никакие его функции не работают</u></b>.\n
🔃 Как только <i>FunPayCardinalRemake</i> инициализируется, данное сообщение изменится.\n
📋 Если <i>FPC</i> долго не инициализируется, проверь логи с помощью команды /logs"""

fpc_init = """✅ <b><u>FunPayCardinalRemake инициализирован!</u></b>\n
...
adv_description = """FunPayCardinalRemake v{}"""
...
withdraw_no_wallets = "❌ На FunPay не найдены сохраненные кошельки для вывода. Добавь кошелек на странице https://funpay.com/account/wallets и попробуй снова."
...
withdraw_amount_error = "❌ Неверная сумма. Введи сумму в рублях, например <code>1000</code>, или <code>all</code> для всего доступного баланса."
withdraw_not_enough_balance = "❌ Недостаточно доступного баланса. Сейчас доступно: <code>{}</code>."
withdraw_preview_error = "❌ Не удалось рассчитать вывод.\n\n<code>{}</code>"
withdraw_confirm_text = "<b>Подтверди вывод средств</b>\n\nС баланса: <code>{}</code>\nК получению: <code>{}</code>\nБудет отправлено: <code>{}</code>\nКошелек: <code>{}</code>\n\nПосле нажатия <b>Да</b> будет отправлен запрос на вывод."
...
withdraw_success = "✅ Запрос на вывод отправлен.\n\nСписано: <code>{}</code>\nК получению: <code>{}</code>\nОтправлено: <code>{}</code>"
withdraw_cancelled = "Вывод отменен."

uah_rate_info = "Текущий курс FunPay: <code>1 ₽ = {} UAH</code>\n\nЧтобы включить гривны или изменить курс вручную, отправь:\n<code>/UAH 0.543</code>\n\nОбновить с FunPay сейчас:\n<code>/UAH auto</code>\n\nВернуть рубли:\n<code>/UAH off</code>"
uah_rate_changed = "✅ Курс FunPay изменен: <code>1 ₽ = {} UAH</code>\n\nПокупки, баланс и вывод считаются прямым пересчетом в UAH."
uah_rate_disabled = "✅ Отображение в UAH выключено. Баланс и суммы показываются в рублях."
uah_rate_error = "❌ Неверный курс. Пример: <code>/UAH 0.543</code>"
uah_rate_updating = "Обновляю курс FunPay с вывода на банковскую карту UA..."
uah_rate_auto_changed = "✅ Курс FunPay обновлен с банковской карты UA: <code>1 ₽ = {} UAH</code>"
uah_rate_auto_error = "❌ Не удалось обновить курс с FunPay. Оставил последний сохраненный курс."

update_disabled_manual = "Обновления отключены. Обновляй скрипт вручную, когда сам решишь."
update_downloading = "Загружаю обновление с felusium/FunPayCardinalRemake..."
update_failed = "❌ Не удалось обновиться: <code>{}</code>"
update_success_restart = "✅ {}\n\nПерезапусти бота командой /restart."
language_changed = "Язык изменен."
lang_warning_uk = "Украинский перевод составлен при помощи ChatGPT."
...
logfile_no_errors = "<b>Ошибок в последнем лог-файле не найдено.</b>"
logfile_no_old_logs = "Старых логов не найдено."
logfile_old_deleted = "✅ Удалено старых лог-файлов: <code>{}</code>"

au_delete_user = "Удалить"
au_delete_confirm = "Удалить пользователя <code>{}</code> из списка авторизованных?"
au_user_deleted = "✅ Пользователь удален."
au_last_user_blocked = "❌ Нельзя удалить последнего авторизованного пользователя."

v_order_price = "<code>$order_price</code> - сумма заказа."
...
/UAH 0.543 - изменить курс FunPay UAH/RUB
/UAH auto - обновить курс с вывода на карту UA
/UAH off - показывать суммы в рублях
/trash - фильтр лишних сообщений FunPay
/old - Список #
/ticket_orders - создать тикет по старым заказам
